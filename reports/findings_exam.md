...
- unique targets: **609**
- findings reported: **45** (from 82 row-level detections, de-duplicated)
- by severity: high=2, low=8, medium=35
- runtime: 0.5s, 0 HTTP requests, 0 errors

| # | severity | classification | count |
|---|---|---|---|
| 1 | medium | `obsolete_accession` | 30 |
| 2 | low | `missing_gene_symbol` | 6 |
| 3 | high | `wrong_accession_mapping` | 2 |
| 4 | medium | `isoform_accession` | 2 |
| 5 | medium | `ambiguous_mention` | 2 |
| 6 | low | `stale_gene_symbol` | 2 |
